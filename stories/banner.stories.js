...
storiesOf("Component|Banners/Major", module).add("With Only Title", () => (
    <MajorBanner title="Banner Title" photo="People Outdoors/shutterstock_116403520.jpg" />
)).add("With all Text Options", () => (
    <MajorBanner photo="People Outdoors/shutterstock_116403520.jpg" title="Banner Title" subtitle="Banner Subtitle"
    body="Banner Body"
    />
))

storiesOf("Component|Banners/Minor", module).add("No Pictures", () => (
    <MinorBanner
    title="Banner Title"
